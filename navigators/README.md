...
See [For Citizens](for-citizens.md) to learn how delegation works, what happens to your VOT3, and how rewards are calculated.

## For Navigators

See [For Navigators](for-navigators.md) to learn about registration, duties, penalties, and the exit process.

## For Developers

See [For Developers](for-developers.md) for contract architecture, key functions, and integration details.
